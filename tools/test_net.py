...
from lib.model.rpn.bbox_transform import bbox_transform_inv_reg, bbox_transform_inv_reg2
...
if __name__ == '__main__':
    ...
    for i in range(num_images):
        ...
        RCNN_loss_cls, RCNN_loss_bbox, RCNN_loss_edge, bbox_sign_prob, \
        ...
        if cfg.TEST.BBOX_REG:
            ...
            if cfg.TRAIN.BBOX_NORMALIZE_TARGETS_PRECOMPUTED:
                ...
                if args.class_agnostic:
                    ...
                    box_deltas = box_deltas.view(-1, 12) * torch.FloatTensor(cfg.TRAIN.BBOX_NORMALIZE_STDS_REG).cuda() \
                                 + torch.FloatTensor(cfg.TRAIN.BBOX_NORMALIZE_MEANS_REG).cuda()
                    box_deltas = box_deltas.view(1, -1, 12 * len(imdb.classes))

            # pred_boxes = bbox_transform_inv_reg(boxes, box_deltas, 1)
            pred_boxes = bbox_transform_inv_reg2(boxes, box_deltas, bbox_sign_prob)
